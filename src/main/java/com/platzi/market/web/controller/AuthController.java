...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken(@RequestBody AuthenticationRequest request){
        ...
        try {
            /*revisamos si el usuario y la contraseña son correctas*/
            ...
            /*BadCredentialsException se ejecuta cuando no ocurra la autenticacion con ese usuario y contraseña */
